...
-  **Azure Fundamentals** — Microsoft *(Cloud, IaaS, Azure Services)*
-  **Cyber Security Virtual Job Simulation** — Deloitte
-  **SQL for Analysts** — Google Developers Group
-  **Introduction to DevOps Tools** — Simplilearn SkillUp *(CI/CD, Version Control)*
